function ConversaChatWindow(apiEndPointUrl,user,lang,enableSending,chatMode)
{ 
    ...
    this.conversaClient = new ConversaClient(apiEndPointUrl);
    this.lang = lang;
    this.currentPage = 0;
    this.rows = 30;
...
ConversaChatWindow.prototype.initialize = function()
{
    this.currentPage = 0;
    this.lastUserId = 0;
    this.lastGroupId = 0;
...
ConversaChatWindow.prototype.setUser = function(user)
{
    this.conversaClient.setCurrentUser(user);
    this.user = user;
}

ConversaChatWindow.prototype.attach = function(htmlElement,title)
{
    ...
    if(this.enableSending){
        ...
        $('#btn-chat').click(function(){
            ...
            if(self.chatMode == 1){
                ...
                self.conversaClient.postTextMessageToUser(self.lastUserId,text,function(data){
            ...
            if(self.chatMode == 2){
                ...
                self.conversaClient.postTextMessageToGroup(self.lastGroupId,text,function(data){
...
ConversaChatWindow.prototype.buildMediaBox = function(message)
{
...
ConversaChatWindow.prototype.tuggleMediaBox = function(message)
{
...
ConversaChatWindow.prototype.showAlert = function(message)
{
...
ConversaChatWindow.prototype.showLoading = function()
{
...
ConversaChatWindow.prototype.hideLoading = function()
{
    $('.loader').remove();
}

ConversaChatWindow.prototype.loadGroupConversation = function(groupId)
{
    this.isLoading = true;
    this.chatMode = 2;
    ...
    this.conversaClient.getGroup(groupId,function(data){
        console.log(data);
    ...
    this.conversaClient.loadGroupChat(groupId,this.rows,offset,function(data){
        ...
        if(errorString.match(/expired|invalid/i)){
            ...
            self.conversaClient.login(self.user.email,self.user.password,function(data){

                self.setUser(data);
                self.conversaClient.setCurrentUser(self.user);
...
ConversaChatWindow.prototype.loadUserConversation = function(toUserId)
{
    this.isLoading = true;
    this.chatMode = 1;
    ...
    this.conversaClient.getUser(toUserId,function(data){
        console.log(data);
    ...
    this.conversaClient.loadUserChat(toUserId,this.rows,offset,function(data){
...
ConversaChatWindow.prototype.renderConversation = function(data)
{
...
ConversaChatWindow.prototype.renderChatRow = function(chatRow){
...
ConversaChatWindow.prototype.renderChatBody = function(chatRow){
