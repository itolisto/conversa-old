    ...
    var mediaViewManager = {
        ...
        init: function(){
            ...
            $('#btn-chat-send-comment').click(function(){
                ...
                _conversaClient.postComment(self.messageId,comment,function(data){
                    ...
                    _conversaApp.handleError(errorString,"loadComments");
        ...
        loadMedia : function(messageId,fileId){
            ...
            _conversaClient.getMessage(messageId,function(data){
                ...
                if(messageType == 'video'){
                 ...
                 _conversaApp.handleError(errorString,"getMessage");
        ...
        loadComments : function(messageId){
            ...
            _conversaClient.getMediaComments(messageId,function(data){
                ...
                _conversaApp.handleError(errorString,"getMediaComments");
            });
