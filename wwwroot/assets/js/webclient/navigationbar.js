    ...
    var navigationBarManager = {
        ...
        renderContacts : function(userList){
            ...
            var self = this;
            _conversaClient.getContacts(function(users){
                ...
                _conversaApp.handleError(errorString,"getContacts");
        ...
        renderGroups : function(userList){
            ...
            var self = this;
            _conversaClient.getFavoriteGroups(function(groups){
                ...
                _conversaApp.handleError(errorString,"getFavoriteGroups");
        ...
        renderRecentActivity : function(userList){
            ...
            _conversaClient.getActivitySummary(function(data){
                ...
                _conversaClient.getUser(usersId.join(','),function(data){
                    ...
                    _conversaClient.getGroup(groupsId.join(','),function(data){
