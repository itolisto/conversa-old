    ...
    _chatManager = {
        ...
        templatePicturePostMediaView : _.template('<div class="post_content" messageid="<%= _id %>"><a href="javascript:_conversaApp.showMediaView(<%= _id %>)"><img src="' + _consts.RootURL + '/api/filedownloader?file=<%= picture_thumb_file_id %>" height="120" width="120" /></a></div>'),
        templateEmoticonPost : _.template('<div class="post_content" messageid="<%= _id %>"><img src="<%= emoticon_image_url %>" height="120" width="120" /></div>'),
        templateVoicePost : _.template('<div class="fa fa-play-circle-o fa-4x post_fa"></div><div class="post_content post_media" messageid="<%= _id %>"><%= body %><br /><a target="_blank" href="javascript:_conversaApp.showMediaView(<%= _id %>)">' + _lang.listenVoice + '</a></div>'),
        templateVideoPost : _.template('<div class="fa fa-video-camera fa-4x post_fa"></div><div class="post_content post_media" messageid="<%= _id %>"><%= body %><br /><a target="_blank" href="javascript:_conversaApp.showMediaView(<%= _id %>)">' + _lang.watchVideo + '</a></div>'),
        ...
        loadNextPage : function(){
            ...
            if(this.chatCurrentUserId != 0){
                ...
                _conversaClient.loadUserChat(this.chatCurrentUserId,this.chatPageRowCount,this.chatCurrentPage,function(data){
                    ...
                    $("#conversation_block").scrollTop(currentHeight - lastHeight);
                     ...
                     _conversaApp.handleError(errorString,"loadUserChat");
                ...
                _conversaClient.loadGroupChat(this.chatCurrentGroupId,this.chatPageRowCount,this.chatCurrentPage,function(data){
                    self.mergeConversation(data);
                    self.render();
                    self.isLoading = false;
                    ...
                    _conversaApp.handleError(errorString,"loadGroupChat");
        ...
        startPrivateChat : function(userId){
            ...
            _conversaClient.loadUserChat(userId,this.chatPageRowCount,this.chatCurrentPage,function(data){
        ...
        startGroupChat : function(groupId){
            ...
            // check password
            _conversaClient.getGroup(groupId,function(data){
                ...
                alertManager.hideLoading();
                _conversaApp.handleError(errorString,"getGroup");
        ...
        enterToGroupChat : function(groupId){
            ...
            _conversaClient.loadGroupChat(groupId,this.chatPageRowCount,this.chatCurrentPage,function(data){
        ...
        render : function(){
            ...
            for(var index = 0 ; index < _.size(this.chatContentPool) ; index++){
                ...
                if(row.read_at == 0 && _conversaClient.currentUser._id == row.from_user_id){
            ...
            var className = ".userId" + _conversaClient.currentUser._id;
            
            for(var index = 0 ; index < _.size(this.chatContentPool) ; index++){
            
                var row = this.chatContentPool[index];
                
                if(_conversaClient.currentUser._id == row.from_user_id){
        ...
        sendTextMessage : function(message){
            ...
            if(self.chatCurrentUserId != 0) {
                ...
                target = _conversaClient.MESSAGE_TAEGET_USER;
            } else if(self.chatCurrentGroupId != 0) {
                targetId = self.chatCurrentGroupId;
                target = _conversaClient.MESSAGE_TAEGET_GROUP;
            } else {
            ...
            _conversaClient.postTextMessage(target,targetId,message,function(data){
                ...
                _conversaApp.handleError(errorString,"postTextMessage");
        ...
        sendMediaMessage : function(file,mediaType,listener){
            ...
            if(mediaType == _conversaClient.MEDIA_TYPE_IMAGE){
                // scale
                resize(file,640,640,100,"image/jpeg",function(blobBigImage){
                    
                    resize(file,240,240,100,"image/jpeg",function(blobSmallImage){
                    
                        _conversaClient.fileUpload(blobBigImage,function(data){
                            
                            var fileId = data;
                            
                            _conversaClient.fileUpload(blobSmallImage,function(data){
                                
                                var thumbId = data;
                                
                                _conversaClient.postMediaMessage(target,mediaType,targetId,fileId,thumbId,function(data){
                                    ...
                                    _conversaApp.handleError(errorString,"postMediaMessage");
                                    listener();
                                ...
                                _conversaApp.handleError(errorString,"fileUpload");
                                listener();
            ...
            if(mediaType == _conversaClient.MEDIA_TYPE_VIDEO || mediaType == _conversaClient.MEDIA_TYPE_AUDIO){
                
                _conversaClient.fileUpload(file,function(data){
                    
                    var fileId = data;
                    
                    _conversaClient.postMediaMessage(target,mediaType,targetId,fileId,0,function(data){
        ...
        sendSticker : function(stickerIdentifier,listener){
            ...
            _conversaClient.postStickerMessage(target,targetId,stickerIdentifier,function(data){
                ...
                _conversaApp.handleError(errorString,"postStickerMessage");
                listener();
        ...
        loadNewMessage : function(){
            ...
            if(self.chatCurrentUserId != 0){
                ...
                _conversaClient.loadUserChat(self.chatCurrentUserId,self.chatPageRowCount,1,function(data){
                    self.mergeConversation(data);
                    self.render();
                    self.scrollToBottom();
                },function(errorString){
                ...
                _conversaClient.loadGroupChat(self.chatCurrentGroupId,self.chatPageRowCount,1,function(data){
                    self.mergeConversation(data);
                    self.render();
                    self.scrollToBottom();
                },function(errorString){
        ...
        deleteMessage : function(messageId,deleteType){
            ...
            _conversaClient.setDelete(messageId,deleteType,function(data){
                ...
                _conversaApp.handleError(errorString,"setDelete");
    ...
    var newMessageChecker = {
        ...
        checkUpdate : function(){
            ...
            _conversaClient.getActivitySummary(function(data){
                ...
                alertManager.hideLoading();
                _conversaApp.handleError(errorMessage,"getActivitySummary");
    ...
    var sideBarManager = {
        ...
        renderUserProfile : function(userId){
            ...
            _conversaClient.getUser(userId,function(data){
                ...
                alertManager.hideLoading();
                _conversaApp.handleError(errorString,"getUser");
