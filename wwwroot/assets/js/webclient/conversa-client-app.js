var _conversaApp = {
    ...
    initApp : function(){
        ...
        // login
        _conversaClient.login(_loginedUser.email,_loginedUser.password,function(data){

            _loginedUser = data;
            _conversaClient.setCurrentUser(_loginedUser);
            ...
            _conversaApp.handleError(errorString,"login");
