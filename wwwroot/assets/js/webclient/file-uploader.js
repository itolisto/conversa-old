    ...
    var fileUploadManager = {
        handleFileSelect : function(event){
            ...
            if(fileType == 'image/jpeg' || fileType == 'image/pjpeg'){
                _chatManager.sendMediaMessage(file,_conversaClient.MEDIA_TYPE_IMAGE,function(){
            ...
            if(fileType == 'video/mp4'){
                _chatManager.sendMediaMessage(file,_conversaClient.MEDIA_TYPE_VIDEO,function(){
                    $('#fileupload-box').css('display','block');
                    $('#fileuploading').css('display','none');
                });
            }
            ...
            if(fileType == 'audio/mp3' || fileType == 'audio/mpeg'){
                _chatManager.sendMediaMessage(file,_conversaClient.MEDIA_TYPE_AUDIO,function(){
                    $('#fileupload-box').css('display','block');
                    $('#fileuploading').css('display','none');
                });
            }
